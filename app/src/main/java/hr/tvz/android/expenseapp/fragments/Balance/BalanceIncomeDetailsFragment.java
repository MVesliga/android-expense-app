...
public class BalanceIncomeDetailsFragment extends Fragment {

    private Balance balance;
    private int yearOfEntry;
    private TextView balanceDetails;
    private ArrayList<Type> listIncopmesByType;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(bundle != null){
            ...
            Call<ArrayList<Type>> call = jsonPlaceholderApi.listByIncomeType(balance.getMonth(), yearOfEntry);
            ...
            call.enqueue(new Callback<ArrayList<Type>>() {
                ...
                public void onResponse(Call<ArrayList<Type>> call, Response<ArrayList<Type>> response) {
                    ...
                    listIncopmesByType = response.body();

                    for(Type t : listIncopmesByType){
                        String content = "";
